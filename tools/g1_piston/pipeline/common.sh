...
PAT="^[^ ]*bin/python ([^ ]*/)?tools/g1_piston/(train_sa[c]|train_grp[o]|eval_checkpoin[t]|render_rollout[s]|probe_critic_rankin[g]|measure_deployed_action_erro[r]|train_b[c]|make_press_demo[s]|probe_press_[a-z]*)\.py"
