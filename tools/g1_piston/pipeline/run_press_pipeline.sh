...
GENS="$R/demo_buffer_v5_dispense_canon $R/demo_buffer_v5_dispense_t01b $R/demo_buffer_v5_dispense_t23"
...
OUT=$R/demo_buffer_v5_press SYNTH_DIRS=$(echo $GENS $R/demo_buffer_v5_dispense_t0123 | tr ' ' ',') $PY tools/g1_piston/build_press_bc_buffer.py >> $LOG 2>&1
